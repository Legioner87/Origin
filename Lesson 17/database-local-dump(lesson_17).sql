...
INSERT INTO `customers` VALUES (144,'Volvo Model Replicas, Co','Berglund','Christina ','0921-12 3555','Berguvsvägen  8',NULL,'Luleå',NULL,'S-958 22','Sweden',1504,53100.00);
INSERT INTO `customers` VALUES (145,'Danish Wholesale Imports','Petersen','Jytte ','31 12 3555','Vinbæltet 34',NULL,'Kobenhavn',NULL,'1734','Denmark',1401,83400.00);
...
INSERT INTO `customers` VALUES (169,'Porto Imports Co.','de Castro','Isabel ','(1) 356-5555','Estrada da saúde n. 58',NULL,'Lisboa',NULL,'1756','Portugal',NULL,0.00);
INSERT INTO `customers` VALUES (171,'Daedalus Designs Imports','Rancé','Martine ','20.16.1555','184, chaussée de Tournai',NULL,'Lille',NULL,'59000','France',1370,82900.00);
...
INSERT INTO `customers` VALUES (209,'Mini Caravy','Citeaux','Frédérique ','88.60.1555','24, place Kléber',NULL,'Strasbourg',NULL,'67000','France',1370,53800.00);
...
INSERT INTO `customers` VALUES (216,'Enaco Distributors','Saavedra','Eduardo ','(93) 203 4555','Rambla de Cataluña, 23',NULL,'Barcelona',NULL,'08022','Spain',1702,60300.00);
...
INSERT INTO `customers` VALUES (223,'Natürlich Autos','Kloss','Horst ','0372-555188','Taucherstraße 10',NULL,'Cunewalde',NULL,'01307','Germany',NULL,0.00);
INSERT INTO `customers` VALUES (227,'Heintze Collectables','Ibsen','Palle','86 21 3555','Smagsloget 45',NULL,'Århus',NULL,'8200','Denmark',1401,120800.00);
INSERT INTO `customers` VALUES (233,'Québec Home Shopping Network','Fresnière','Jean ','(514) 555-8054','43 rue St. Laurent',NULL,'Montréal','Québec','H1J 1C3','Canada',1286,48700.00);
INSERT INTO `customers` VALUES (237,'ANG Resellers','Camino','Alejandra ','(91) 745 6555','Gran Vía, 1',NULL,'Madrid',NULL,'28001','Spain',NULL,0.00);
...
INSERT INTO `customers` VALUES (256,'Auto Associés & Cie.','Tonini','Daniel ','30.59.8555','67, avenue de l\'Europe',NULL,'Versailles',NULL,'78000','France',1370,77900.00);
INSERT INTO `customers` VALUES (259,'Toms Spezialitäten, Ltd','Pfalzheim','Henriette ','0221-5554327','Mehrheimerstr. 369',NULL,'Köln',NULL,'50739','Germany',1504,120400.00);
...
INSERT INTO `customers` VALUES (273,'Franken Gifts, Co','Franken','Peter ','089-0877555','Berliner Platz 43',NULL,'München',NULL,'80805','Germany',NULL,0.00);
...
INSERT INTO `customers` VALUES (298,'Vida Sport, Ltd','Holz','Mihael','0897-034555','Grenzacherweg 237',NULL,'Genève',NULL,'1203','Switzerland',1702,141300.00);
...
INSERT INTO `customers` VALUES (335,'Cramer Spezialitäten, Ltd','Cramer','Philip ','0555-09555','Maubelstr. 90',NULL,'Brandenburg',NULL,'14776','Germany',NULL,0.00);
...
INSERT INTO `customers` VALUES (361,'Kommission Auto','Josephs','Karin','0251-555259','Luisenstr. 48',NULL,'Münster',NULL,'44087','Germany',NULL,0.00);
...
INSERT INTO `customers` VALUES (409,'Stuttgart Collectable Exchange','Müller','Rita ','0711-555361','Adenauerallee 900',NULL,'Stuttgart',NULL,'70563','Germany',NULL,0.00);
...
INSERT INTO `customers` VALUES (448,'Scandinavian Gift Ideas','Larsson','Martha','0695-34 6555','Åkergatan 24',NULL,'Bräcke',NULL,'S-844 67','Sweden',1504,116400.00);
...
INSERT INTO `customers` VALUES (458,'Corrida Auto Replicas, Ltd','Sommer','Martín ','(91) 555 22 82','C/ Araquil, 67',NULL,'Madrid',NULL,'28023','Spain',1702,104600.00);
...
INSERT INTO `customers` VALUES (477,'Mit Vergnügen & Co.','Moos','Hanna ','0621-08555','Forsterstr. 57',NULL,'Mannheim',NULL,'68306','Germany',NULL,0.00);
...
INSERT INTO `customers` VALUES (484,'Iberia Gift Imports, Corp.','Roel','José Pedro ','(95) 555 82 82','C/ Romero, 33',NULL,'Sevilla',NULL,'41101','Spain',1702,65700.00);
...
CREATE TABLE `drinks` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `drinks_name_uindex` (`name`)
...
INSERT INTO `drinks` VALUES (1,'juice',250);
INSERT INTO `drinks` VALUES (2,'tea',350);
INSERT INTO `drinks` VALUES (3,'coffee',150);
...
CREATE TABLE `meals` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `meals_name_uindex` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `meals` VALUES (1,'omlet',250);
INSERT INTO `meals` VALUES (2,'porridge',350);
INSERT INTO `meals` VALUES (3,'sausages',450);
...
INSERT INTO `movies` VALUES (1,'Labyrinth','Jim Henson',1986,1);
INSERT INTO `movies` VALUES (2,'Highlander','Russell Mulcahy',1986,1);
INSERT INTO `movies` VALUES (3,'Alien','Ridley Scott',1979,2);
INSERT INTO `movies` VALUES (4,'Conan the Barbarian','John Milius',1982,1);
INSERT INTO `movies` VALUES (5,'The Hobbit: An Unexpected Journey','Peter Jackson',2012,1);
INSERT INTO `movies` VALUES (6,'The Dark Crystal','Jim Henson',1982,1);
INSERT INTO `movies` VALUES (7,'Star Wars: A New Hope','George Lucas',1977,2);
INSERT INTO `movies` VALUES (8,'Harry Potter and the Order of the Phoenix','David Yates',2007,1);
INSERT INTO `movies` VALUES (9,'Fantastic Beasts and Where to Find Them ','David Yates',2016,1);
INSERT INTO `movies` VALUES (10,'Excalibur','John Boorman',1981,1);
INSERT INTO `movies` VALUES (11,'Time Bandits','Terry Gilliam',1981,1);
INSERT INTO `movies` VALUES (12,'Pan\'s Labyrinth','Guillermo Del Toro',2006,1);
INSERT INTO `movies` VALUES (13,'Blade Runner','Ridley Scott',1982,2);
INSERT INTO `movies` VALUES (14,'Interstellar','Christopher Nolan',2014,2);
INSERT INTO `movies` VALUES (15,'A.I. Artificial Intelligence','Steven Spielberg',2001,2);
INSERT INTO `movies` VALUES (16,'The Matrix','The Wachowskis',1999,2);
INSERT INTO `movies` VALUES (17,'Gattaca','Andrew Niccol',1997,2);
INSERT INTO `movies` VALUES (18,'Avatar','James Cameron',2009,2);
INSERT INTO `movies` VALUES (19,'Moon','Duncan Jones',2009,2);
INSERT INTO `movies` VALUES (20,'Galaxy Quest','Dean Parisot',1999,2);
INSERT INTO `movies` VALUES (21,'The Fifth Element','Luc Besson',1997,2);
INSERT INTO `movies` VALUES (22,'Inception','Christopher Nolan',2010,2);
INSERT INTO `movies` VALUES (23,'District 9','Neill Blokamp',2009,2);
INSERT INTO `movies` VALUES (24,'Her','Spike Jonez',2013,2);
INSERT INTO `movies` VALUES (25,'Pulp Fiction','Quentin Tarantino',1994,5);
INSERT INTO `movies` VALUES (26,'Reservoir Dogs','Quentin Tarantino',1992,5);
INSERT INTO `movies` VALUES (27,'Transcendence','Wally Pfister',2014,2);
INSERT INTO `movies` VALUES (28,'Contact','Robert Zemekis',1997,2);
...
INSERT INTO `people` VALUES ('arya@stark.org','Arya','Stark','');
INSERT INTO `people` VALUES ('brandon@stark.org','Brandon','Stark','Bran');
INSERT INTO `people` VALUES ('bronn@blackwater.info','Bronn','Blackwater','');
INSERT INTO `people` VALUES ('cersei@lannister.com','Cersei','Lannister','');
INSERT INTO `people` VALUES ('daenerys@dragonstone.org','Daenerys','Targaryen','');
INSERT INTO `people` VALUES ('davos@seaworth.org','Davos','Seaworth','The Onion Knight');
INSERT INTO `people` VALUES ('gregor@clegane.org','Gregor','Clegane','');
INSERT INTO `people` VALUES ('jaime@lannister.org','Jaime','Lannister','');
INSERT INTO `people` VALUES ('jon@snow.org','Jon','Snow','King Jon the First');
INSERT INTO `people` VALUES ('samwell@nights-watch.org','Samwell','Tarley','');
INSERT INTO `people` VALUES ('sandor@clegane.org','Sandor','Clegane','');
INSERT INTO `people` VALUES ('sansa@stark.org','Sansa','Stark-Bolton','');
...
INSERT INTO `shows` VALUES (1,'Supernatural',15,2005);
INSERT INTO `shows` VALUES (2,'Heroes',4,2006);
INSERT INTO `shows` VALUES (3,'Star Trek',3,1966);
INSERT INTO `shows` VALUES (4,'That \'70s Show',8,1998);
INSERT INTO `shows` VALUES (5,'Game of Thrones',8,2011);
INSERT INTO `shows` VALUES (6,'Breaking Bad',5,2008);
INSERT INTO `shows` VALUES (7,'Better Call Saul',5,2015);
INSERT INTO `shows` VALUES (8,'Stranger Things',2,2016);
INSERT INTO `shows` VALUES (9,'Black Mirror',5,2011);
INSERT INTO `shows` VALUES (10,'Westworld',3,2016);
...
-- Dump completed on 2022-01-25 21:53:23

#Просто выводим тип продукта Motorcycles и цены на эот тип
select productLine, buyPrice
from products
where productLine='Motorcycles';

# Выводим тип продукта Motorcycles сумму цен этого типа продукта
select productLine ,sum(buyPrice) as Sum_price
from products
where productLine='Motorcycles'
group by productLine;

# Выводим тип продукта Motorcycles и среднее арифметическое этих цен этого типа продукта
select productLine ,avg(buyPrice) as Sum_price
from products
where productLine='Motorcycles'
group by productLine;

# Выводим тип продукта Motorcycles и выводим min И max цен данного  типа продукта
select productLine ,min(buyPrice) as Min_price, max(buyPrice) as Max_price
from products
where productLine='Motorcycles'
group by productLine;
# или впринципи и так можно по всем типам min и max
select productLine ,min(buyPrice) as Min_price, max(buyPrice) as Max_price
from products
group by productLine;


# Всего 13 значений с типом Motorcycles.
select productLine ,count(*) as Sum_price
from products
where productLine='Motorcycles'
group by productLine;

# вывести  уникальные значения productLine
#и посчитать сумму buyPrice всех уникальных  productLine.
select  productLine,
sum(buyPrice) as col_value
from products
group by productLine;
...
,productName
,buyPrice
#, ROW_NUMBER() over (order by productName) as row_sum
from products;
# подсчёт строк  от 1 до 110
select productCode
,productName
,buyPrice
, ROW_NUMBER() over (partition by productCode order by productCode) as row_sum
from products;

-------------------------------------------------------#ДЗ ПУНКТ 4 И 5
# -----------------------------------------Оконные функции с использованием RANK!!!
select productCode
,productName
,buyPrice
, ROW_NUMBER() over (
	order by productName) as row_num,
    rank() over(order by buyPrice) AS rank_sum,
    dense_rank() over (order by buyPrice) as dense_rank_num
from products;
##или
select productLine,
	sum(orderValue) as order_value_sum,
    RANK() over (order by orderValue) as row_rank
from productlinesales_2
group by productLine;

#------------------------------Оконная функция с использованием "LAG"
select customerName
,orderDate
,lag(orderDate,1)
